...
public class Messages implements ConfigurationSection {
   ...
   @Annotations.Key("totem-disabled-in-pvp")
   private String totemDisabledInPvp = "&b&lТотем небыл использован, т.к он отключен в &e&lPVP &b&lрежиме";
   @Annotations.Key("pvp-started-with-powerups")
   @Annotations.Comment({"Данное сообщение будет появляться только тогда, когда настроена функция 'commands-on-powerups-disable'"})
   ...
   public String getTotemDisabledInPvp() {
      return this.totemDisabledInPvp;
   }

   public String getPvpStartedWithPowerups() {
      return this.pvpStartedWithPowerups;
   }

   public String toString() {
      return "Messages{pvpStarted='" + this.pvpStarted + '\'' + ", pvpStartedTitle='" + this.pvpStartedTitle + '\'' + ", pvpStartedSubtitle='" + this.pvpStartedSubtitle + '\'' + ", pvpStopped='" + this.pvpStopped + '\'' + ", pvpStoppedTitle='" + this.pvpStoppedTitle + '\'' + ", pvpStoppedSubtitle='" + this.pvpStoppedSubtitle + '\'' + ", pvpStoppedActionbar='" + this.pvpStoppedActionbar + '\'' + ", inPvpBossbar='" + this.inPvpBossbar + '\'' + ", inPvpActionbar='" + this.inPvpActionbar + '\'' + ", pvpLeaved='" + this.pvpLeaved + '\'' + ", commandsDisabled='" + this.commandsDisabled + '\'' + ", itemCooldown='" + this.itemCooldown + '\'' + ", itemDisabledInPvp='" + this.itemDisabledInPvp + '\'' + ", totemCooldown='" + this.totemCooldown + '\'' + ", totemDisabledInPvp='" + this.totemDisabledInPvp + '\'' + ", pvpStartedWithPowerups='" + this.pvpStartedWithPowerups + '\'' + '}';
   }
}
