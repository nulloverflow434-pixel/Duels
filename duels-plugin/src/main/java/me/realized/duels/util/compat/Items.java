...
public final class Items {
    ...
    public static boolean isHealSplash(final ItemStack item) {
        ...
        try {
            Object potionType = meta.getClass().getMethod("getBasePotionType").invoke(meta);
            return potionType != null && potionType.toString().contains("HEAL");
            ...
            try {
                ...
                return type != null && type.toString().contains("HEAL");
